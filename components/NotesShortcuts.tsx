...
export default function NotesShortcuts() {
  ...
  const getRandomColor = () => {
    const colors = ["bg-red-400", "bg-blue-400", "bg-green-400", "bg-yellow-400", "bg-purple-400", "bg-pink-400", "bg-teal-400"];
    return colors[Math.floor(Math.random() * colors.length)];
  };

  return (
    <section className="container max-w-4xl py-6 lg:py-10 flex flex-col space-y-6 mt-60">
      <h1 className="text-[2.3rem] md:text-[3.3rem] lg:text-[4.5rem] leading-[1] font-bold dark:bg-gradient-to-b dark:from-[rgba(244,244,255,1)] dark:to-[rgba(181,180,207,1)] dark:text-transparent dark:bg-clip-text py-2 text-center pt-20 md:pt-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {links.map((link) => (
          ...
          >
            ...
            <Link href={link.href} className="absolute left-0 top-0 h-full w-full">
