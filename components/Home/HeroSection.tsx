      ...
      <BlurFade delay={1} inView>
        <div className="container lg:px-72 pt-20 flex flex-col md:flex-row items-center justify-between w-full space-y-6">
          <div className="w-1/2 lg:w-3/4 flex items-center justify-center">
            <button className="group relative h-12 rounded-full border-2 dark:border-[#9f65e2] border-[#813981] bg-gradient-to-r dark:from-[#070e41] dark:to-[#9f65e2] from-[#7642a7] to-[#09139b] px-6 text-white">
