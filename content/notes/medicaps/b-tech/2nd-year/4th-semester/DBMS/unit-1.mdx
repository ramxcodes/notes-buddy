---
title: "Unit 1: Database Management System"
description: Basic Concepts Data Vs Information, Definition of Database, Advantages of Database Systems, Components of DBMS, DBMS Architecture and Data Independence, Data modelling, Entity Relationship Model, Relational, Network, Hierarchical and ObjectOriented Models. Data Modelling Using the Entity Relationship Model.
date: 2025-01-15
...
💡 **TIP**: Data becomes information when it is processed and contextualised.
...
📝 **NOTE**: A database typically requires a **Database Management System (DBMS)** to manage and interact with the stored data efficiently.
...
⚠️ **CAUTION**: While databases improve data management, they require careful setup and maintenance to prevent errors or security breaches.
...
📝 **NOTE**: The hardware ensures the DBMS functions effectively by providing computational power and storage.
...
💡 **TIP**: Popular DBMS software includes SQL Server, PostgreSQL, and MongoDB.
...
⚠️ **CAUTION**: Ensuring data integrity and security is essential for maintaining reliable databases.
...
📝 **NOTE**: Proper procedures ensure consistent and secure database usage.
...
💡 **TIP**: The database engine ensures reliability and consistency through ACID properties (Atomicity, Consistency, Isolation, Durability).
...
📝 **NOTE**: 3-tier architecture provides enhanced modularity and separation of concerns compared to 1-tier or 2-tier systems.
...
💡 **TIP**: This separation ensures flexibility and supports data independence.
...
⚠️ **CAUTION**: Achieving full data independence is challenging but critical for system flexibility and maintainability.
...
📝 **NOTE**: Data models act as a blueprint for creating and maintaining a database system.
...
1. **Hierarchical Model**
   ...
   💡 **TIP**: Best suited for applications with fixed relationships, like an organisational chart.
...
3. **Relational Model**
   ...
   📝 **NOTE**: SQL is primarily based on the relational model.
...
4. **Entity-Relationship (ER) Model**
   ...
   ⚠️ **CAUTION**: Complex systems may require careful handling of entity relationships.
...
Entities:  
- **Employee**: Attributes – ID, Name, Salary.  
- **Department**: Attributes – ID, Name, Location.  
Relationship:  
...
💡 **TIP**: ER diagrams help bridge the gap between stakeholders and database designers.
...
⚠️ **CAUTION**: Weak entities must have a **discriminator attribute** (partial key) and a **relationship with a strong entity**.
...
📝 **NOTE**: Attributes are linked to their entities using straight lines in an ER diagram.
...
💡 **TIP**: SQL (Structured Query Language) is used to manage and query relational databases.
...
⚠️ **CAUTION**: Avoid violating these properties, as they ensure the integrity of the relational model.
...
💡 **TIP**: The network model provides more flexibility than the hierarchical model by supporting complex relationships.
...
📝 **NOTE**: A set can have one owner and multiple members, supporting many-to-many relationships.
...
💡 **TIP**: The hierarchical model is ideal for applications with a clear parent-child relationship, like organisational structures.
...
💡 **TIP**: The object-oriented model is suitable for applications that require complex data representation, such as multimedia or CAD (Computer-Aided Design) systems.
...
📝 **NOTE**: In OOM, an object encapsulates both **data** and **behaviour**.
...
💡 **TIP**: The ER model is widely used during the database design phase to map out the system before implementation.
...
📝 **NOTE**: Entities are usually represented by rectangles in an ER diagram.
...
💡 **TIP**: Attributes are represented as ovals in an ER diagram.
...
- Example: A `Student` enrolls in a `Course` – the relationship is **Enrollment**.
...
1. **Entities**:  
   ...
   - `Course`: Attributes – `Course_ID`, `Course_Name`, `Credits`  
