...
![image.png](https://img.notionusercontent.com/s3/prod-files-secure%2F2569df28-564b-470f-aafe-abe52b815e0b%2F264620b1-a088-4562-94d4-fa2dc6c68cee%2Fimage.png/size/w=1280?exp=1735310971&sig=4icGW5Emmr1rgbG3xvKvwPtSn_bI83FrnRWqWm48lkM)

![image.png](https://img.notionusercontent.com/s3/prod-files-secure%2F2569df28-564b-470f-aafe-abe52b815e0b%2F5350dfa3-3514-40d8-9b29-0491c8c6ea42%2Fimage.png/size/w=660?exp=1735310985&sig=w6odoEaZ3moMGSWhmVZJoVMh3y4MJjWDhpcA-JvdKL8)

![image.png](https://img.notionusercontent.com/s3/prod-files-secure%2F2569df28-564b-470f-aafe-abe52b815e0b%2F10af25f2-d56f-49ce-aac3-898e4de42bb7%2Fimage.png/size/w=1280?exp=1735310993&sig=wWuCYC0OnGc10I2XAf-aEfdQmyTAtinLC30PzTtJDdw)
...
Ensures that the software meets specified requirements, functions reliably, and satisfies user needs.

| Aspect | Description |
| --- | --- |
| **Functional Quality** | Ensures the software functions correctly according to requirements. |
| **Non-Functional Quality** | Addresses usability, performance, security, and reliability beyond core functionality. |
| **Product vs. Process Quality** | Product quality refers to the final product, while process quality ensures good development practices. |
| **Quality Models** | Models like ISO/IEC 25010 and CMMI help in standardizing and measuring quality. |

---

### 2. **Approaches for Quality Assurance (QA)**

QA includes processes to ensure quality through testing, reviews, and adherence to best practices.

| Approach | Description |
| --- | --- |
| **Manual Testing** | Exploratory, ad-hoc, and UI testing to validate functionality. |
| **Automated Testing** | Unit, integration, and regression tests run automatically to detect issues early. |
| **Static Code Analysis** | Analyzes code without executing it, identifying errors or security flaws. |
| **CI/CD** | Automated testing within the build pipeline for immediate feedback. |
| **TDD & BDD** | Writing tests before or alongside code to clarify requirements and improve code quality. |
| **Risk-Based Testing** | Prioritizes testing efforts on high-risk areas to optimize resource allocation. |
| **User Acceptance Testing** | Ensures the software meets end-user requirements before final release. |

---

### 3. **Software Testing**

Testing validates and verifies software functionality, usability, performance, and security.

| Type | Description |
| --- | --- |
| **Unit Testing** | Tests individual code units or components for correctness. |
| **Integration Testing** | Tests interaction between modules to ensure they work together. |
| **System Testing** | Tests the complete system against requirements. |
| **User Acceptance Testing (UAT)** | Final test by end-users to validate the software meets their requirements. |
| **Functional Testing** | Verifies specific functionalities according to requirements. |
| **Non-Functional Testing** | Assesses aspects like performance, security, and usability. |
| **White-Box Testing** | Tests internal structures or logic using code knowledge. |
| **Black-Box Testing** | Tests external functionality without internal code knowledge. |
| **Exploratory Testing** | Informal testing based on tester intuition and experience. |
...
Two complementary processes ensuring the software is developed and meets user needs.

| Aspect | Verification | Validation |
| --- | --- | --- |
| **Purpose** | Ensures software conforms to specifications. | Ensures software meets user requirements. |
| **Focus** | Process-oriented | Product-oriented |
| **Question Answered** | "Are we building the product right?" | "Are we building the right product?" |
| **Timing** | Ongoing throughout development | Primarily near project completion |
| **Techniques** | Reviews, walkthroughs, static testing | UAT, system testing, beta testing |

---

### 5. **Types of Testing**

Various types of testing target different aspects and levels of software functionality, reliability, and performance.

| Testing Type | Purpose |
| --- | --- |
| **Functional Testing** | Validates functionality against requirements (e.g., unit, integration, system testing). |
| **Non-Functional Testing** | Assesses aspects like performance, usability, security, reliability. |
| **White-Box Testing** | Tests internal code structures (e.g., path, branch testing). |
| **Black-Box Testing** | Tests inputs and outputs without internal code knowledge. |
| **Exploratory Testing** | Informal testing based on exploration and intuition. |
| **Regression Testing** | Ensures new changes do not disrupt existing functionality. |
| **Acceptance Testing** | Confirms readiness for release by end-users or stakeholders. |
| **Static Testing** | Analyzes code or documents without execution (e.g., code reviews, static analysis). |
| **Dynamic Testing** | Involves executing the software to validate behavior and performance. |
| **End-to-End (E2E) Testing** | Validates complete workflows to ensure all integrated parts function correctly. |
| **Security Testing** | Identifies and mitigates vulnerabilities to ensure data protection. |

---

### 6. **Risk Assessment**

A process of identifying, analyzing, and prioritizing potential project risks.

| Step | Description |
| --- | --- |
| **Identify Risks** | Recognize possible risks affecting quality, budget, timeline, or performance. |
| **Analyze Risks** | Assess likelihood and impact, often using a risk matrix to categorize risks. |
| **Prioritize Risks** | Rank risks based on severity to allocate resources effectively. |
| **Mitigate Risks** | Plan actions to reduce the likelihood or impact of prioritized risks. |
| **Monitor Risks** | Continuously review and adjust risk assessments throughout the project lifecycle. |

---

### 7. **Risk Mitigation**

Strategies to manage identified risks by reducing their impact or likelihood.

| Mitigation Strategy | Description | Example |
| --- | --- | --- |
| **Risk Avoidance** | Alter project plans to avoid risks entirely. | Choosing a proven technology over a new one. |
| **Risk Reduction** | Take actions to minimize risk impact or likelihood. | Conducting regular testing for performance issues. |
| **Risk Transfer** | Shift risk responsibility to a third party. | Outsourcing security to a specialized vendor. |
| **Risk Acceptance** | Accept the risk if its impact is low or mitigation is costly. | Accepting minor bugs in non-critical areas. |

---

### 8. **Monitoring and Management**

Continuous tracking and adjustments to ensure the project stays aligned with goals.

| Aspect | Monitoring | Management |
| --- | --- | --- |
| **Project Progress** | Track timeline and milestones. | Adjust tasks and resources to stay on schedule. |
| **Risk Management** | Identify and assess risks regularly. | Implement and adjust mitigation strategies. |
| **Performance** | Monitor key metrics (e.g., response times). | Manage resource allocation for performance needs. |
| **Budget** | Track expenses vs. planned budget. | Adjust spending or reallocate funds as needed. |
| **Stakeholder Communication** | Provide regular updates to stakeholders. | Manage expectations and address concerns. |
...
| --- | --- |
| **Quality vs. QA Approaches** | Quality focuses on product standards, while QA approaches (like testing) ensure those standards are met. |
| **Verification vs. Validation** | Verification ensures compliance with specifications, while validation ensures the product meets user needs. |
| **Types of Testing** | Functional tests verify specific functions, non-functional tests assess usability, performance, etc. |
| **Risk Assessment vs. Mitigation** | Risk assessment identifies and analyzes risks; risk mitigation involves actions to manage those risks. |
| **Monitoring vs. Management** | Monitoring tracks project status, while management adjusts resources and plans based on that status. |

This overview provides a structured summary of each topic, highlighting essential differences and key aspects of each area in quality assurance, risk management, and project monitoring and management.
