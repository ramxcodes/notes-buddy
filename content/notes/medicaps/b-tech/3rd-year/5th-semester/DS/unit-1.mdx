...
<Quiz 
  questions={[
    { 
      ...
      options: ["Create dashboards", "Extract insights", "Clean raw data", "Build APIs"], 
      correctIndex: 1 
    },
    { 
      question: "Which component involves removing inconsistencies in data?", 
      options: ["Model Deployment", "Data Cleaning", "Feature Engineering", "Data Collection"], 
      correctIndex: 1 
    },
    { 
      question: "What is a key characteristic of Big Data?", 
      options: ["Volume", "Dashboards", "Visualization", "Normalization"], 
      correctIndex: 0 
    },
    { 
    ...
    { 
      ...
      options: ["Exploratory Data Analysis", "Enhanced Data Accuracy", "Efficient Data Application", "Extended Data Access"], 
      correctIndex: 0 
    },
    { 
      question: "Which tool is commonly used for Data Visualization?", 
      options: ["SQL", "PyTorch", "Tableau", "TensorFlow"], 
      correctIndex: 2 
    },
    { 
      question: "Which technology is part of the data layer?", 
      options: ["Hadoop", "Keras", "Tableau", "Scikit-learn"], 
      correctIndex: 0 
    },
    { 
      question: "What problem does overfitting affect?", 
      options: ["Data collection", "Feature scaling", "Model generalization", "Visualization"], 
      correctIndex: 2 
    },
    { 
      question: "Which model is used for sequential data?", 
      options: ["Support Vector Machines", "CNNs", "RNNs", "Decision Trees"], 
      correctIndex: 2 
    },
    { 
      question: "Which term describes the process of mapping raw data?", 
      options: ["Data Deployment", "Data Wrangling", "Data Mining", "Data Visualization"], 
      correctIndex: 1 
    }
  ]}
/>
