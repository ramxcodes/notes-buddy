...
<Quiz 
  questions={[
    { 
      ...
      options: ["A probability measure", "A random variable", "A set of outcomes", "An experiment outcome"], 
      correctIndex: 2 
    },
    { 
      question: "Which type of sample space is infinite?", 
      options: ["Compound", "Simple", "Continuous", "Discrete"], 
      correctIndex: 2 
    },
    { 
      question: "What is the PMF used for?", 
      options: ["Event prediction", "Discrete variables", "Continuous variables", "Infinite outcomes"], 
      correctIndex: 1 
    },
    { 
      question: "What defines conditional probability?", 
      options: ["P(A∩B)", "P(A|B)", "P(A∪B)", "P(A)×P(B)"], 
      correctIndex: 1 
    },
    { 
      question: "What is true for independent events?", 
      options: ["P(A∩B)=P(A)", "P(A)×P(B)", "P(A|B)=P(A)", "P(A∩B)=P(A)×P(B)"], 
      correctIndex: 3 
    },
    { 
      question: "Which variable is countable?", 
      options: ["Random", "Continuous", "Discrete", "Compound"], 
      correctIndex: 2 
    },
    { 
      question: "What is the shape of a normal distribution?", 
      options: ["Symmetric bell curve", "Linear regression", "Skewed line", "Bimodal peaks"], 
      correctIndex: 0 
    },
    { 
      question: "What does a Z-score measure?", 
      options: ["Sampling error", "Event correlation", "Probability density", "Distance from mean"], 
      correctIndex: 3 
    },
    { 
      question: "What does ARIMA model?", 
      options: ["Time series data", "Random variables", "Normal distribution", "Sample spaces"], 
      correctIndex: 0 
    },
    { 
      question: "What is the purpose of statistical inference?", 
      options: ["Define event space", "Predict random events", "Draw conclusions about a population", "Estimate random variable distribution"], 
      correctIndex: 2 
    }
  ]}
/>
